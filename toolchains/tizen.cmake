...
if (NOT ${TIZEN_DEVICE})
  ...
  set(CMAKE_C_FLAGS "-march=armv7-a -mtune=cortex-a7 -mfpu=neon-vfpv4 ${CMAKE_C_FLAGS}")
  set(CMAKE_CXX_FLAGS "-march=armv7-a -mtune=cortex-a7 -mfpu=neon-vfpv4 ${CMAKE_CXX_FLAGS}")
endif()
